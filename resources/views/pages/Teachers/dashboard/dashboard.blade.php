                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('student.index')}}" target="_blank"><span class="text-danger"> {{trans('main_trans.afficher_donner')}} </span></a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('sections')}}" target="_blank"><span class="text-danger">   {{trans('main_trans.afficher_donner')}} </span></a>
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab nav-border" style="position: relative;">
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">{{trans('main_trans.systeme')}}  </h5>
                                    </div>
                                            ...
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                @forelse(\App\Models\Teacher::latest()->take(5)->get() as $teacher)
                                                    ...
                                                    <tr>
                                                        ...
                                                        @empty
                                                            <td class="alert-danger" colspan="8">{{$teacher->specializations->no_data}} </td>
                                                    </tr>
                                                    </tbody>
                                                @endforelse
                                            </table>
