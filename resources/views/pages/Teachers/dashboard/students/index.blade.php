...
@section('css')
    @toastr_css
@section('title'){{ trans('Students_trans.absenceT') }}
...
@section('content')
    ...
    <h5 style="font-family: 'Cairo', sans-serif;color: red">   {{ trans('Students_trans.dateToday') }}  : {{ date('Y-m-d') }}</h5>
