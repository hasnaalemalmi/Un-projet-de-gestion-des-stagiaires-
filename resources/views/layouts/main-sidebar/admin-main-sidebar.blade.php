<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- menu title -->
        <li class="mt-10 mb-10  text-primary pl-4 ">{{trans('main_trans.Programname')}} </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('libraryW.index')}}"> {{trans('main_trans.library')}}   </a> </li>
            </ul>
        </li>
   
  
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#notes-icon">
                <div class="pull-left"><i class="fa fa-edit"></i><span class="right-nav-text">{{trans('Grades_trans.Notes')}}</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="notes-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('Notes.index')}}"> {{trans('Grades_trans.Notes')}}   </a> </li>
            </ul>
        </li>
